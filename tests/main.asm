...
; nop loop delay; preserves all registers
delay:
    push bc
    ld c,0x80 ; outer counter
_delay_outer:
...
; all characters 0x01-0xff excluding console special characters, zero-terminated
ALL_CHARS:
    ; skip 0x08, 0x0a, 0x0d, 0x7f
    defb 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x09,0x0b,0x0c,0x0e,0x0f
    ...
    defb 0x70,0x71,0x72,0x73,0x74,0x75,0x76,0x77,0x78,0x79,0x7a,0x7b,0x7c,0x7d,0x7e
